...
> 🔹 Prompt:
> “Explain in detail how createBrowserRouter and RouterProvider work together in React Router.
  Cover:
  - How they differ from a normal parent–child JSX relationship
  - What createBrowserRouter actually returns
  - How RouterProvider uses that object internally
  - How route elements are rendered when navigating
  - How data or state flows between routes and the router
  Include a simple visual diagram and a working example showing routes with ProtectedRoute and Browser components.”
